...
$site_name = getSetting($conn, 'site_name', 'Workloop');
$site_description = getSetting($conn, 'site_description', 'Connect with freelancers worldwide');
$site_email = getSetting($conn, 'site_email', 'admin@workloop.com');
$site_phone = getSetting($conn, 'site_phone', '+1 (123) 456-7890');
$platform_fee_percentage = getSetting($conn, 'platform_fee_percentage', '10');
$min_withdrawal_amount = getSetting($conn, 'min_withdrawal_amount', '50');
...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <!-- Main Content -->
    <div class="flex-1 p-8 ml-64 overflow-auto max-w-8xl">
            ...
            <section class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="email" id="site_email" name="site_email" value="<?= htmlspecialchars($site_email) ?>"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" id="site_phone" name="site_phone" value="<?= htmlspecialchars($site_phone) ?>"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
            </section>
